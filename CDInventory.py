...
class DataProcessor:
    ...
    def create_file(file_name):
        '''Opens the .txt file in append mode, to create if it doesn't exist
        
        Args:
            file_name (string): name of file used to read the data from and write to it 
...
DataProcessor.create_file(strFileName) 
...
while True:
    ...
    # 3.3 process add a CD
        ...
        IO.add_cd(lstTbl) # added this after moving the code to that function def above
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
